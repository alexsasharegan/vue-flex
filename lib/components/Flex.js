...
export default {
	...
	render(h, { props, data, children }) {
		...
		componentData.class.push(`vf__flex-dir--${props.column ? "column" : "row"}${props.reverse ? "-reverse" : ""}`)
		componentData.class.push(classObj)

		classObj[`vf__flex-wrap${props.wrapReverse ? "-reverse" : ""}`] = !props.noWrap
		classObj[`vf__flex-nowrap`] = props.noWrap
		classObj[`vf__grow-children`] = props.noWrap
